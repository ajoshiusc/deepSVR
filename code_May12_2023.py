...
subfiles_train = sublist_full[78:79]
...
print("stacks mean: ", stacks[0].mean())
...
for epoch in range(max_epochs):
    ...
    print(f'epoch:{epoch}; reg_loss:{(torch.sqrt(vol_loss/(64*64*32*6)))/stacks[0].mean()}; GTloss:{GTloss(recon_image, image).item()}')
