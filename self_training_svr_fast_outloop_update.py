...
randstack_transforms = Compose(
    [
        ...
        ScaleIntensityRangePercentilesd(
            keys=["image"], lower=10, upper=90, b_min=0.0, b_max=10.0, clip=True),
        # make stacks
...
#reg.load_state_dict(torch.load('/home/ajoshi/projects/deepSVR/outsvr/epoch_reg_2200.pth'))

reg.train()
#superres.load_state_dict(torch.load('/home/ajoshi/epoch_2020.pth'));


#superres.load_state_dict(torch.load('/home/ajoshi/projects/deepSVR/outsvr/epoch_superres_2200.pth'))
