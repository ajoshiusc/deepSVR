...
image = batch_data["image"].to(device) + .01
stacks = batch_data["stacks"].to(device) + .01
...
reg.train()
superres.load_state_dict(torch.load('/home/ajoshi/epoch_1490.pth'));
superres.train()
...
write_nifti(recon_image[0,0],f'zero_stacks2/deepsvr_recon_orig.nii.gz')

write_nifti(image[0,0],'zero_stacks2/deepsvr_orig.nii.gz')
...
for epoch in range(max_epochs):
    ...
    write_nifti(recon_image[0,0],f'zero_stacks2/deepsvr_recon_{epoch}.nii.gz')
