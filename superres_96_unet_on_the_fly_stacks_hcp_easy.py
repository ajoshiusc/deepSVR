...
trained_model_file = './model_96_unet_large_lrem4_hcp_easy/epoch_'+str(start_epoch)+'.pth'
...
randstack_transforms = Compose(
    [
        ...
        Resized(keys=["stack0", "stack1", "stack2", "stack3",
                "stack4", "stack5"], spatial_size=[96, 96, 96]),
...
for epoch in range(start_epoch+1, max_epochs):
    ...
    if np.mod(epoch, 10) == 0:
        torch.save(model.state_dict(),
                   './model_96_unet_large_lrem4_hcp_easy/epoch_'+str(epoch)+'.pth')
