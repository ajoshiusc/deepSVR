...
trained_model_file = './model_64_unet_large_lrem4_hcp_hard/epoch_'+str(start_epoch)+'.pth'
...
for epoch in range(start_epoch+1, max_epochs):
    ...
    if np.mod(epoch, 10) == 0:
        torch.save(model.state_dict(),
                   './model_64_unet_large_lrem4_hcp_hard/epoch_'+str(epoch)+'.pth')
    ...
    np.savez('large_unet_on_the_fly_loss_values_hcp_hard.npz',
